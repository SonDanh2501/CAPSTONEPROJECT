...
import { apiCreateCouponPitchOwner } from "apis";
import { showModal } from "store/app/appSlice";
import { useOutletContext } from "react-router-dom";

const CreateCouponOwn = () => {
    ...
    const handleCreateCoupon = async (data) => {
        ...
        if (invalids === 0) {
            ...
            window.scrollTo(0, 0);
            const response = await apiCreateCouponPitchOwner(finalPayload);
...
export default CreateCouponOwn