...
import { apiDeleteCoupon, apiGetCouponAdmin, apiGetNotifications } from "apis";
  ...
  return (
    ...
    >
      ...
      <div className="ml-2 py-4 border-b-2 border-gray-300">
        <h1 className="text-2xl font-bold tracking-tight">Manage Notfication</h1>
      </div>
      <div className="w-full p-2">
        ...
        <div className="w-full flex justify-end my-8">
          <Pagination type={"notification"} totalCount={counts} />
        </div>
      </div>
    </div>
  );
